        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <Link href="/dashboard/calendario">
            <Button
              ...
              className={`w-full justify-start gap-2 ${activeTab === "calendar" ? "bg-violet-600 hover:bg-violet-700" : ""} ${!isSidebarOpen ? "px-0 justify-center" : ""}`}
          ...
          <Link href="/dashboard/configuracion">
            <Button
              ...
              className={`w-full justify-start gap-2 ${activeTab === "settings" ? "bg-violet-600 hover:bg-violet-700" : ""} ${!isSidebarOpen ? "px-0 justify-center" : ""}`}
